...
// Clase para  despliegue de gráfica de Barras
   ...
   function construyeTabla($dep,$mun,$tipoeleccion,$titulo) {
	...
	if(version_compare(phpversion(),"4.3.0", ">")){
	   ...
	   echo "<tr class=\"totimpar\"><td class=\"c1\">Votos Emitidos:</td><td class=\"c2\">".number_format($this->ors['NULOS']+$this->ors['BLANCOS']+$this->ors['VOTOSVALIDOS'])."</td><td class=\"c3\"></td></tr>" ;
