				...
				<div id="menu">
					...
					<tr>
						<td width="35%">
							<div id="mdetalle">
								Proceso:
								<select name="detalle" onChange="location.href='presentacion'+document.formesa.detalle.options[document.formesa.detalle.selectedIndex].value+'.php'">		
								<option value="">Corporaci&oacute;n Municipal</option>
								<option value="1" SELECTED>Actas por Municipio</option>
						...
						<td width="13%" class="menuMovil"></td>
					</tr>
					</form>
					</table>					
				</div>
					...
					<table width="100%" border="0">
						<tr>
							...
							<td class="footerRight">
									...
									<a href="http://resultados2011.tse.org.gt/index_sv.php" target="_blank">Segunda Elección Presidencial 2011</a>
							</td>
						</tr>
					</table>
				</div>
