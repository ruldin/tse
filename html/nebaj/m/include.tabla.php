...
private $ors;
	...
	if(version_compare(phpversion(),"4.3.0", ">")){
		...
		else
		{
			...
			if ($pemitidos>0)
				$pVotosValidos=($this->ors['VOTOSVALIDOS']/$pemitidos)*100;
			else
				$pVotosValidos=0;
			...
			$html.='<tr class="totpar"><td class="c1">Votos V&aacute;lidos:</td><td class="c2">'.number_format($this->ors['VOTOSVALIDOS'],0).'</td><td class="c3">'.number_format($pVotosValidos,2).'%</td></tr>';
			...
			$html.='<tr class="totimpar"><td class="c1">Votos Emitidos:</td><td class="c2">'.number_format($this->ors['TOTALVOTOS'],0).'</td><td class="c3">'.number_format($pemitidos,2).'%</td></tr>';
			...
			$html.='<tr class="totimpar"><td title="Total Juntas Receptoras de Votos" class="c1">Total JRV:</td><td class="c2">'.number_format($this->ors['CNTMESAS'],0).'</td><td class="c3"></td></tr>';
			$html.='<tr class="totpar"><td title="Juntas Receptoras de Votos Totalizadas" class="c1"><b>JRV Totalizadas:</b></td><td class="c2"><b>'.number_format($this->ors['MESASPRO'],0).'</b></td><td class="c3"><b>'.number_format($this->ors['PMESASPRO'],2).'%</b></td></tr>';
			$html.='</tbody></table>';
		}
		echo $html;
	}
